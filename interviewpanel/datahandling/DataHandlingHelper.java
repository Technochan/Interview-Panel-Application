package com.zsgs.chandru.interviewpanel.datahandling;
...
public class DataHandlingHelper {
    ...
    private final String DATA_FOLDER_PATH = System.getProperty("user.dir") + File.separator + "InterviewPanelDatabase";
